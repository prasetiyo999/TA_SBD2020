<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LIstPenyewa.aspx.cs" Inherits="TA_SBD.LIstPenyewa" %>
...
runat="server" OnTextChanged="txtEmail_TextChanged"></asp:TextBox></td>
 </tr>
 <tr>
 <td>
 </td>
